...
def preprocess_dataset():
    dataset = load_dataset('json', data_files='/workspace/finn3.5/magento_training.json', split='train')
...
training_args = TrainingArguments(
    ...
    seed=42,
    report_to=['wandb'],
    run_name='qwen2.5-coder-7b-magento',
)
trainer = Trainer(
    model=model,
    args=training_args,
...
os.system('cd /workspace/newtek-ai-model && git add . && git commit -m "Fine-tuned magento model" && git push')